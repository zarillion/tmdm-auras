trigger = function(event, ...)
    ...
    if event == "COMBAT_LOG_EVENT_UNFILTERED" then
        ...
        if health ~= 0 and health < BOSS * 0.88 and not aura_env.stopCalled then
        ...
        if
            ...
            and sourceName == "Zarillion"
            and spellName == "Summon Infernal"
            and not aura_env.infernalTimer
        then
        ...
        -- check for p3
        if health ~= 0 and health < BOSS * 0.5 then
