                ...
                if aura_env.phase == 3 and aura_env.spearCount == 3 then
                    ...
                    aura_env.swapTimer = C_Timer.NewTimer(19, function()
                        ...
                        C_Timer.After(1, function()
                            aura_env.Emit("m2=|cffff0000SWAP SIDES!|r;s=sonar", "Nellow")
                        end)
                        C_Timer.After(2, function()
                            aura_env.Emit("m2=|cff00ff00SWAP SIDES!!|r;s=sonar", "Nellow")
                        end)
                        C_Timer.After(3, function()
                            aura_env.Emit("m2=|cff0000ffSWAP SIDES!!!|r;s=sonar", "Nellow")
                        end)
                    end)
                end
            end
