...
aura_env.GIGA_LOCATIONS = {
    ...
    [2] = {
        ...
        [2] = {'RUBBLE LEFT', 'RUBBLE RIGHT', 'NEXT TO CORNER', 'PILLAR RIGHT', 'PILLAR LEFT', 'BACK CORNER', 'RUBBLE LEFT'}
    },
    [3] = {
        [1] = {'BACK CORNER', 'PILLAR LEFT', 'NEXT TO CORNER', 'PILLAR RIGHT', 'BACK CORNER'},
        [2] = {'RUBBLE RIGHT', 'RUBBLE LEFT', 'NEXT TO CORNER', 'PILLAR LEFT', 'PILLAR RIGHT', 'BACK CORNER', 'RUBBLE RIGHT'}
    }
}
...
aura_env.setDBMOptions = function ()
    for option, value in pairs(DBM_OPTIONS) do
        C_ChatInfo.SendAddonMessage(PREFIX, 'bm=2276:'..option..'='..tostring(value), 'RAID')
    end
end
